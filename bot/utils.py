...
default_languages = {
    ...
    "uz": {
        ...
        "product_add_cart": "Mahsulotlaringiz pastdagi savatchaga tushadi o'sha yerdan buyurtma berishingiz mumkin:",
    ...
    "ru": {
        ...
        "product_add_cart": "Маҳсулотларингиз пастдаги саватчага тушади ўша ердан буюртма беришингиз мумкин:",
